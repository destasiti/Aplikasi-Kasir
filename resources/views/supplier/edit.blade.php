                        ...
                        <div class="col-sm-9">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control @error('NamaSupplier') is-invalid @enderror"
                                    id="NamaSupplier" name="NamaSupplier" value="{{ old('NamaSupplier', $supplier->NamaSupplier) }}" required>
                            </div>
                            @error('NamaSupplier')
                        ...
                        <div class="col-sm-9">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control @error('Kontak') is-invalid @enderror"
                                    id="Kontak" name="Kontak" value="{{ old('Kontak', $supplier->Kontak) }}" required>
                            </div>
                            @error('Kontak')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
